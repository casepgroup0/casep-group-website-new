...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CASEP GROUP — Transforming Organizations Through Technology" },
      {
        name: "description",
        content:
          "CASEP GROUP is a Ghanaian technology company delivering software development, cloud solutions, business automation, and digital transformation.",
      },
      { name: "author", content: "CASEP GROUP" },
      { property: "og:site_name", content: "CASEP GROUP" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#062A4D" },
    ],
    links: [
